...
import Nothing from '../Compontnts/Nothing';
        ...
        <>
            {
                !loaded ? <Loader /> :
                    <div className="container1">
                        <div className='post-img'><img src={BASE_URL + picURL} alt="Failed to load" /></div>
                                        ...
                                        commentsArray.length > 0 ? (
                                            commentsArray.map((comment, i) => (
                                                <div className='comment-item' key={i}>
                                                    <span className='user-comment' onClick={() => { NavigateProfile(comment.name) }}>
                                                        <img className='commentedUserImg' src={BASE_URL + comment.pic} alt="" />
                                                    </span>
                                                    <span className='comment-span'>
                                                        <strong className='user-name' onClick={() => { NavigateProfile(comment.name) }}>{comment.name} &nbsp;</strong>
                                                        {comment.comment}
                                                    </span>
                                                </div>
                                            ))
